                    ...
                    <div class="head-login clearfix " style="padding-top: 7px;">
                        <ul class="ja-login">
                            ...
                            %><li>
                                ...
                                <a class="register-switch" href="#" data-target="#">Hi..&nbsp;
                                    <%=strvo.getFirstName()%></a></li>
                                    <%
                                    }%><li>
                                <%
                                    if (session.getAttribute("ALLSTUDENTDATA") == null) {
                                            ...
                                            <div class="col-xs-12 mega-col-nav" data-width="12">
                                                <div class="mega-inner">
                                                    <ul class="mega-nav level1">
                                                        ...
                                                        <li  data-id="543" data-level="2"><a class="" href="whypcsacademyaction.do" data-target="#">Why PCS Cloud Academy?</a> </li>
                                                                        ...
                                                                        <div class="col-xs-12 mega-col-nav" data-width="12">
                                                                            <div class="mega-inner">
                                                                                <ul class="mega-nav level2">
                                                                                    ...
                                                                                    <li  data-id="489" data-level="3" data-xicon="fa fa-file-text"><a class="" href="summertrainning.do" data-target="#"><i class="fa fa-file-text"></i>Summer Training 2016</a></li>
                                                                                    <li  data-id="491" data-level="3" data-xicon="fa fa-list-alt"><a class="" href="wintertrainning.do" data-target="#"><i class="fa fa-list-alt"></i>Winter Training 2015-2016</a></li>
